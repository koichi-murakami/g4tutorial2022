...
//   (演習実行手順)
//     Hands-onのスライドを参照し、以下の「？」部分を書き換えて、クラスを完成させる
//-----------------------------------------------------------------------------
...
//   (演習実行手順)
//     Hands-onのスライドを参照し、次行の「？」部分を書き換えて、クラスを完成させる
//-----------------------------------------------------------------------------
...
//   (演習実行手順)
//     1. 右側のコメントに従い、「？」部分を部分を書き換えて'main()'プログラムを完成させる
//     2. 以下のコマンドでプログラムを実行し結果を見る
//         % c++ C04_WhatIsInheritance.cc
//-----------------------------------------------------------------------------
