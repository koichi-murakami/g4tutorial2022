...
//   (演習実行手順)
//     右側のコメントに従い、「？」部分を部分を書き換えて'main()'プログラムを完成させる
//     次に、以下のコマンドでプログラムを実行し結果を見る
//       % c++ C05_WhatIsVirtualFunction.cc
//-----------------------------------------------------------------------------
...
// [演習 2]  virtual関数の定義
//   (演習実行手順)
//     'Shape_2P'定義の15行目を以下の様に変更した後、main()を実行し、[演習１]の結果と比べよ
...
//
//   [注] 実行すると'compile error'となる。その理由は、Shape_2Parea()関数がpure vartual
//        になったので、main()の45行目のShape_2Pオブジェクト作成ができなくなったから。
//        'error'修正には、'aShape'にアクセスしている部分を全てコメントアウトする
//-----------------------------------------------------------------------------
